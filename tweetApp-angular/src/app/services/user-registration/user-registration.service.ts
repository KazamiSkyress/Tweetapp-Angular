...
export const API_URL="http://43.205.235.54:8082/api/v1.0/tweets/register";
export const Users_URL ="http://43.205.235.54:8082/api/v1.0/tweets/users/all";
export const Search_URL = "http://43.205.235.54:8082/api/v1.0/tweets/user/search/";
export const Forgot_URL="http://43.205.235.54:8082/api/v1.0/tweets";
@Injectable({
  providedIn: 'root'
})
